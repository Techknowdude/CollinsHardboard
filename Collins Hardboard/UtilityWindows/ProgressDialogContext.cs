...
namespace UtilityWindows
{
	public class ProgressDialogContext
	{
		...
		public void Report(Int32 percentProgress, string message)
		{
			if(Worker.WorkerReportsProgress)
				Worker.ReportProgress(percentProgress, message);
		}

		public void Report(Int32 percentProgress, string format, params object[] arg)
		{
			if(Worker.WorkerReportsProgress)
		...
		public void ReportWithCancellationCheck(Int32 percentProgress, string message)
		{
			ThrowIfCancellationPending();
		...
		public void ReportWithCancellationCheck(Int32 percentProgress, string format, params object[] arg)
		{
			ThrowIfCancellationPending();
